...
const objectCounter = (obj) => {
    ...
    return obj.reduce((previousValue, currentValue) => previousValue + 1, 0)
}
...
const stringReverse = (str) => {
    ...
    return wordsArray.reduce((previousValue, currentValue) => currentValue + ' ' + previousValue)
}
...
const statistics = (obj) => {
    ...
    return obj.reduce((previousValue, currentValue) => {
        let voteTo = currentValue.votes_To;
        if (previousValue[voteTo] !== undefined) {
            previousValue[voteTo] += 1
        } else {
            previousValue[voteTo] = 1
        }
